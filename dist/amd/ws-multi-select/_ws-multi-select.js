define(['exports', '../imports', '../ws-dropdown/dropdown-menu'], function (exports, _imports, _dropdownMenu) {
  'use strict';
  ...
  var WSMultiSelect = exports.WSMultiSelect = function (_Component) {
    ...
    _createClass(WSMultiSelect, [{
      ...
      value: function render() {
        ...
        return _imports.React.createElement(
          ...
          _imports.React.createElement('input', { type: 'text', ref: function ref(element) {
          ...
          _imports.React.createElement(
            ...
            _imports.React.createElement(_dropdownMenu.DropdownMenu, { items: filteredItems })
          ),
